...
@section('title', isset($metaTag) ? (json_decode($metaTag->title) ?? 'Danh mục - '.$category->name) : 'Danh mục - '.$category->name)

@section('metaTags')
    @include('theme.layouts.metaTags', ['localPage' => false, 'pageTitle' => $category->name, 'objectPage' => $category])
@endsection
