    ...
    <div class="px-4 mx-auto max-w-screen-2xl">
        ...
        <form  method="POST" action="{{ route('post.store') }}" class="" enctype="multipart/form-data">
                ...
                <div class="">
                    <div class="p-4 mb-4 grid gap-4 grid-cols-1 lg:grid-cols-2 bg-white shadow-md sm:rounded-lg">
                        <div class="sm:col-span-2">
                            ...
                            <input type="text" name="title" id="title" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" placeholder="Nhập tiêu đề ..." required="" onfocusin="prevData(this)" onchange="titleDefault(this)">
                        </div>
                        <div class="sm:col-span-2">
                            <label for="slug" class="block mb-2 font-semibold text-gray-900">Slug</label>
                            <input type="text" name="slug" id="slug" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" placeholder="Nhập slug ..." required="" onfocusin="prevData(this)" onchange="ogUrlDefault(this)">
                        </div>
                        <div class="sm:col-span-2">
                    ...
                    <div class="p-4 mb-4 grid gap-4 grid-cols-1 lg:grid-cols-2 bg-white shadow-md sm:rounded-lg">
                        <div class="col-span-2">
                            ...
                            <select id="category_id" name="category_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                <?php
                                    $categoryPosts = App\Models\Category::where('slug','bai-viet')->orWhere('slug', 'du-an')->pluck('id')->toArray();
                                ?>
                                @foreach($categories as $category)
                                    @if(in_array($category->parent_id,  $categoryPosts))
            ...
            <div class="flex items-center flex-wrap gap-4">
                ...
                {{-- SEO  --}}
                @include('admin.SEO.seo_drawer', ['isCreateForm' => true, 'urlDefault' => ''])
