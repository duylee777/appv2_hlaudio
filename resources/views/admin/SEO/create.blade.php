    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        ...
        <li aria-current="page">
            <div class="flex items-center">
                ...
                <span class="ms-1 text-sm font-medium text-cyan-500 md:ms-2">{{__('create')}}</span>
            </div>
        </li>
    </ol>
</nav>
<div class="py-4">
    <section class="bg-white">
        <div class="bg-gray-50 py-4 sm:py-5 mt-5">
            ...
            <h2 class=" mx-4 mb-4 text-xl font-bold text-blue-600">Thêm mới</h2>
            <form  method="POST" action="{{ route('SEO.store') }}" class="px-4" enctype="multipart/form-data">
                @csrf
                <div class="flex flex-row flex-wrap gap-4">
                    <div class="w-[calc(50%-8px)] max-md:w-full">
                        ...
                        <input type="text" name="seo_name" id="seo_name" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" placeholder="name..." required="">
                    </div>
                    <div class="w-[calc(50%-8px)] max-md:w-full">
                        <label for="seo_type" class="block mb-2 font-semibold text-gray-900">Type (<span class="text-rose-600">*</span>)</label>
                        <input type="text" name="seo_type" id="seo_type" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" placeholder="type..." required="">
                    </div>
                    <div class="w-[calc(50%-8px)] max-md:w-full hidden">
                        ...
                        <input type="text" name="seo_type_id" id="seo_type_id" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" placeholder="type_id...">
                    </div>
                    <div class="w-[calc(50%-8px)] max-md:w-full">
