        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('SEO.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                    ...
                    <span class="ms-3">Cài đặt SEO Page</span>
                </a>
            </li>
