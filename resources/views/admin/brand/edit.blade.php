    ...
    <form  method="POST" action="{{ route('brand.update', $brand->id) }}" class="px-4" enctype="multipart/form-data">
        ...
        <div class="grid gap-4 mb-4 grid-cols-2">
            ...
            <div class="">
                ...
                <input type="text" name="name" id="name" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" value="{{ $brand->name }}" required="" onfocusin="prevData(this)" onchange="titleDefault(this)">
            </div>
            ...
            <div class="col-span-2">
                ...
                <div class="p-4 flex flex-col lg:flex-row items-center gap-4 bg-white border border-gray-200 rounded-lg shadow">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none" aria-describedby="file_input_help" name="image" id="file_brand_input" type="file" onchange="document.getElementById('preview_brand_image').src = window.URL.createObjectURL(this.files[0])" accept="image/*">
        ...
        <div class="text-left">
            ...
            {{-- SEO  --}}
            @include('admin.SEO.seo_drawer', ['isCreateForm' => false,'titleDefault' => $brand->name, 'urlBase' => url(route('theme.brand', '')), 'urlDefault' => url(route('theme.brand', $brand->slug))])
