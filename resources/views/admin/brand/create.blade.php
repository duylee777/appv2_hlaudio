    ...
    <form  method="POST" action="{{ route('brand.store') }}" class="px-4" enctype="multipart/form-data">
        ...
        <div class="flex flex-col gap-4">
            <div class="">
                ...
                <input type="text" name="name" id="name" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" placeholder="Nhập tên thương hiệu ..." required="" onfocusin="prevData(this)" onchange="titleDefault(this)">
            </div>
            <div class="">
                ...
                <div class="p-4 flex flex-col lg:flex-row items-center gap-4 bg-white border border-gray-200 rounded-lg shadow">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none" aria-describedby="file_input_help" name="image" id="file_input" type="file" onchange="document.getElementById('preview_image').src = window.URL.createObjectURL(this.files[0])" required accept="image/*">
        ...
        <div class="text-left">
            ...
            {{-- SEO  --}}
            @include('admin.SEO.seo_drawer', ['isCreateForm' => true, 'urlDefault' => url(route('theme.brand', ''))])
