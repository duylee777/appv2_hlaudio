    ...
    <div class="px-4 mx-auto max-w-screen-2xl">
        ...
        <form id="new-product-form" action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <section class="grid gap-4 grid-cols-1 lg:grid-cols-2">
                <div class="p-4 mb-4 grid gap-4 grid-cols-1 lg:grid-cols-2 bg-white shadow-md sm:rounded-lg">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" id="name" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Nhập tên sản phẩm ..." required="" onfocusin="prevData(this)" onchange="titleDefault(this)">
                    </div>
                    <div class="col-span-2">
                        <label for="slug" class="block mb-2 text-sm font-medium text-gray-900">Slug (tối ưu url)</label>
                        <input type="text" id="slug" name="slug" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Có thể để trống, mặc định theo tên sản phẩm..." onfocusin="prevData(this)" onchange="ogUrlDefault(this)">
                    </div>
                    <div class="col-span-2">
                ...
                <div class="col-span-2">
                    ...
                    <div class="p-4 flex flex-col lg:flex-row items-center gap-4 bg-white border border-gray-200 rounded-lg shadow">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none" aria-describedby="file_thumbnails_help" name="thumb" id="file_thumbnails" type="file" onchange="document.getElementById('thumbnails_image').src = window.URL.createObjectURL(this.files[0]);" accept="image/*">
            ...
            <div class="p-4 mb-4 grid gap-4 grid-cols-1 lg:grid-cols-2 bg-white shadow-md sm:rounded-lg">
                <div class="sm:col-span-2">
                    ...
                    <div class="flex flex-col gap-2 mt-4">
                        ...
                        <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none" aria-describedby="file_input_help" name="" id="file_input" type="file" multiple accept="image/*">
            ...
            <div class="flex items-center flex-wrap gap-4">
                ...
                {{-- SEO  --}}
                @include('admin.SEO.seo_drawer', ['isCreateForm' => true, 'urlDefault' => url(route('theme.product_detail'))])
