    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        ...
        <li aria-current="page">
            <div class="flex items-center">
                ...
                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2">Đăng ký nhận tin</span>
            </div>
        </li>
    </ol>
</nav>
        ...
        <div class="relative overflow-hidden bg-white shadow-md sm:rounded-lg">
            <div class="flex flex-col px-4 py-3 space-y-3 lg:flex-row lg:items-center lg:justify-between lg:space-y-0 lg:space-x-4">
                <div class="flex items-center flex-1 space-x-4">
                    <h2 class="text-black text-2xl font-semibold">Danh sách mail đăng ký nhận tin</h2>
                </div>
            ...
            <div class="overflow-x-auto">
                <div class="flex flex-wrap items-center gap-4 justify-end px-4 mb-4">
                    <div class="grow">
                        <label for="" class="text-xs font-semibold text-blue-400">Tìm kiếm mail khách hàng</label>
